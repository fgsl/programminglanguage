            ...
            if (textoDoBotao.equals("=")){
                ...
                switch (Calculadora.this.operacao) {
                    ...
                    case "/":
                        ...
                        break;   
                    case "?":
                    nome = new JTextField ("Wellington Prestes");
                    ...
                    case "x!":
                        ...
                        break; 
                    case "%":
                        resultado = valorAtual + (percentual * valorAtual);
                        break; 
                    case "HEX":
                        resultado = acumulador / valorAtual;
                        break;
                    case "sin":
                    resultado = Math.sin(valorAtual);
                        break; 
                    case "ln":
                        resultado = acumulador / valorAtual;
                        break; 
                    case "PI":
                        resultado = Math.PI * valorAtual * valorAtual;
                        break; 
                    case "cos":
                        resultado = Math.cos(valorAtual);
                        break;
                    case "log":
                        resultado = Math.log(valorAtual) / Math.log(acumulador);
                        break; 
                    case "tan":
                        resultado = Math.tan(valorAtual);
                        break; 
                    case "√":
                    ...
                    case "EXP":
                        ...
                        break; 
                    case "x^y":
                        //resultado = Double.parseDouble(valorAtual.getText());
                        break; 
